...
import { CATALOG, clampParams, MATERIAL_KEYS, RECOMMENDED_MATERIALS } from "./catalog.js?v=832e871a";
import { buildModel, defaultParams, matchArchetype, matchArchetypeScored, ARCHETYPE_BY_ID, SIMS } from "./archetypes.js?v=832e871a";
import { buildProgramModel, validateProgram, clampProgramParams, defaultProgramParams, programSims } from "./program.js?v=832e871a";
import { MATERIALS, makeMaterial, setQuality, surfaceMaps } from "./geometry.js?v=832e871a";
import { exportSTEP, exportDXF, exportOBJ, exportGLB, exportSTL, downloadBlob, collectPartTriangles } from "./exporters.js?v=832e871a";
import { compileAsset, validateAsset, readinessScore, computeInertial } from "./robot.js?v=832e871a";
import { exportURDF, exportUSDA, exportMJCF, exportBundle, stripCIR, verifyExports as verifyRobotExports } from "./robot-export.js?v=832e871a";
import { buildAssetRecord, ASSET_CATEGORIES } from "./asset-record.js?v=832e871a";
import { measureForm, measurementText, formAgreement, orientUpright, silhouettes } from "./measure.js?v=832e871a";
import { planRepresentation, buildSpecification, specText } from "./threespec.js?v=832e871a";
import { specSummary, applyPatch } from "./spec-build.js?v=832e871a";
import { compileSpec, partsAffectedBy } from "./spec-compile.js?v=832e871a";
import { buildStructuredSpec, structuredSpecText, rebuildEligibility, MODE, ORIGIN } from "./model-spec.js?v=832e871a";
import { applyModifiers, runOperation, captureBaseline } from "./modifier.js?v=832e871a";
import { buildFromSpec, specThreeCode, specSummaryText } from "./spec-cad.js?v=832e871a";
import { createDroneSim } from "./drone-sim.js?v=832e871a";
import { positionsFromObject3D, refineFromMesh } from "./mesh-loft.js?v=832e871a";
import { applyParameter, partFields, applyPartField } from "./drone-params.js?v=832e871a";
import { COMPONENT_CATALOG, CATALOG_GROUPS, fitTargets, applyComponent, addComponentAsPart } from "./drone-catalog.js?v=832e871a";
import { PRINTERS, MATERIALS as PRINT_MATERIALS, estimatePrint } from "./print-estimate.js?v=832e871a";
