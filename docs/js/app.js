...
import { CATALOG, clampParams, MATERIAL_KEYS, RECOMMENDED_MATERIALS } from "./catalog.js?v=2d99286f";
import { buildModel, defaultParams, matchArchetype, matchArchetypeScored, ARCHETYPE_BY_ID, SIMS } from "./archetypes.js?v=2d99286f";
import { buildProgramModel, validateProgram, clampProgramParams, defaultProgramParams, programSims } from "./program.js?v=2d99286f";
import { MATERIALS, makeMaterial, setQuality, surfaceMaps } from "./geometry.js?v=2d99286f";
import { exportSTEP, exportDXF, exportOBJ, exportGLB, exportSTL, downloadBlob, collectPartTriangles } from "./exporters.js?v=2d99286f";
import { compileAsset, validateAsset, readinessScore, computeInertial } from "./robot.js?v=2d99286f";
import { exportURDF, exportUSDA, exportMJCF, exportBundle, stripCIR, verifyExports as verifyRobotExports } from "./robot-export.js?v=2d99286f";
import { buildAssetRecord, ASSET_CATEGORIES } from "./asset-record.js?v=2d99286f";
import { measureForm, measurementText, formAgreement, orientUpright, silhouettes } from "./measure.js?v=2d99286f";
import { planRepresentation, buildSpecification, specText } from "./threespec.js?v=2d99286f";
import { specSummary, applyPatch } from "./spec-build.js?v=2d99286f";
import { compileSpec, partsAffectedBy } from "./spec-compile.js?v=2d99286f";
import { buildStructuredSpec, structuredSpecText, rebuildEligibility, MODE, ORIGIN } from "./model-spec.js?v=2d99286f";
import { applyModifiers, runOperation, captureBaseline } from "./modifier.js?v=2d99286f";
import { buildFromSpec, specThreeCode, specSummaryText } from "./spec-cad.js?v=2d99286f";
import { createDroneSim } from "./drone-sim.js?v=2d99286f";
import { positionsFromObject3D, refineFromMesh } from "./mesh-loft.js?v=2d99286f";
import { applyParameter, partFields, applyPartField } from "./drone-params.js?v=2d99286f";
import { COMPONENT_CATALOG, CATALOG_GROUPS, fitTargets, applyComponent, addComponentAsPart } from "./drone-catalog.js?v=2d99286f";
import { PRINTERS, MATERIALS as PRINT_MATERIALS, estimatePrint } from "./print-estimate.js?v=2d99286f";
