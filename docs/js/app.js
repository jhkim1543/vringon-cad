...
import { requireAuth, logout } from "./auth.js?v=d78ba17d";
import { CATALOG, clampParams, MATERIAL_KEYS, RECOMMENDED_MATERIALS } from "./catalog.js?v=d78ba17d";
import { buildModel, defaultParams, matchArchetype, matchArchetypeScored, ARCHETYPE_BY_ID, SIMS } from "./archetypes.js?v=d78ba17d";
import { buildProgramModel, validateProgram, clampProgramParams, defaultProgramParams, programSims } from "./program.js?v=d78ba17d";
import { MATERIALS, makeMaterial, setQuality, surfaceMaps } from "./geometry.js?v=d78ba17d";
import { exportSTEP, exportDXF, exportOBJ, exportGLB, exportSTL, downloadBlob, collectPartTriangles } from "./exporters.js?v=d78ba17d";
import { compileAsset, validateAsset, readinessScore, computeInertial } from "./robot.js?v=d78ba17d";
import { exportURDF, exportUSDA, exportMJCF, exportBundle, stripCIR, verifyExports as verifyRobotExports } from "./robot-export.js?v=d78ba17d";
import { buildAssetRecord, ASSET_CATEGORIES } from "./asset-record.js?v=d78ba17d";
import { measureForm, measurementText, formAgreement, orientUpright, silhouettes } from "./measure.js?v=d78ba17d";
import { planRepresentation, buildSpecification, specText } from "./threespec.js?v=d78ba17d";
import { specSummary, applyPatch } from "./spec-build.js?v=d78ba17d";
import { compileSpec, partsAffectedBy } from "./spec-compile.js?v=d78ba17d";
import { buildStructuredSpec, structuredSpecText, rebuildEligibility, MODE, ORIGIN } from "./model-spec.js?v=d78ba17d";
import { applyModifiers, runOperation, captureBaseline } from "./modifier.js?v=d78ba17d";
import { buildFromSpec, specThreeCode, specSummaryText } from "./spec-cad.js?v=d78ba17d";
import { createDroneSim } from "./drone-sim.js?v=d78ba17d";
import { positionsFromObject3D, refineFromMesh } from "./mesh-loft.js?v=d78ba17d";
import { applyParameter, partFields, applyPartField } from "./drone-params.js?v=d78ba17d";
import { COMPONENT_CATALOG, CATALOG_GROUPS, fitTargets, applyComponent, addComponentAsPart } from "./drone-catalog.js?v=d78ba17d";
import { PRINTERS, MATERIALS as PRINT_MATERIALS, estimatePrint } from "./print-estimate.js?v=d78ba17d";
