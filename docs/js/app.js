...
import { requireAuth, logout } from "./auth.js?v=9ac70d99";
import { CATALOG, clampParams, MATERIAL_KEYS, RECOMMENDED_MATERIALS } from "./catalog.js?v=9ac70d99";
import { buildModel, defaultParams, matchArchetype, matchArchetypeScored, ARCHETYPE_BY_ID, SIMS } from "./archetypes.js?v=9ac70d99";
import { buildProgramModel, validateProgram, clampProgramParams, defaultProgramParams, programSims } from "./program.js?v=9ac70d99";
import { MATERIALS, makeMaterial, setQuality, surfaceMaps } from "./geometry.js?v=9ac70d99";
import { exportSTEP, exportDXF, exportOBJ, exportGLB, exportSTL, downloadBlob, collectPartTriangles } from "./exporters.js?v=9ac70d99";
import { compileAsset, validateAsset, readinessScore, computeInertial } from "./robot.js?v=9ac70d99";
import { exportURDF, exportUSDA, exportMJCF, exportBundle, stripCIR, verifyExports as verifyRobotExports } from "./robot-export.js?v=9ac70d99";
import { buildAssetRecord, ASSET_CATEGORIES } from "./asset-record.js?v=9ac70d99";
import { measureForm, measurementText, formAgreement, orientUpright, silhouettes } from "./measure.js?v=9ac70d99";
import { planRepresentation, buildSpecification, specText } from "./threespec.js?v=9ac70d99";
import { specSummary, applyPatch } from "./spec-build.js?v=9ac70d99";
import { compileSpec, partsAffectedBy } from "./spec-compile.js?v=9ac70d99";
import { buildStructuredSpec, structuredSpecText, rebuildEligibility, MODE, ORIGIN } from "./model-spec.js?v=9ac70d99";
import { applyModifiers, runOperation, captureBaseline } from "./modifier.js?v=9ac70d99";
import { buildFromSpec, specThreeCode, specSummaryText } from "./spec-cad.js?v=9ac70d99";
import { createDroneSim } from "./drone-sim.js?v=9ac70d99";
import { positionsFromObject3D, refineFromMesh } from "./mesh-loft.js?v=9ac70d99";
import { applyParameter, partFields, applyPartField } from "./drone-params.js?v=9ac70d99";
import { COMPONENT_CATALOG, CATALOG_GROUPS, fitTargets, applyComponent, addComponentAsPart } from "./drone-catalog.js?v=9ac70d99";
import { PRINTERS, MATERIALS as PRINT_MATERIALS, estimatePrint } from "./print-estimate.js?v=9ac70d99";
