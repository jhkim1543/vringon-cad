...
import { requireAuth, logout } from "./auth.js?v=396db0bf";
import { CATALOG, clampParams, MATERIAL_KEYS, RECOMMENDED_MATERIALS } from "./catalog.js?v=396db0bf";
import { buildModel, defaultParams, matchArchetype, matchArchetypeScored, ARCHETYPE_BY_ID, SIMS } from "./archetypes.js?v=396db0bf";
import { buildProgramModel, validateProgram, clampProgramParams, defaultProgramParams, programSims } from "./program.js?v=396db0bf";
import { MATERIALS, makeMaterial, setQuality, surfaceMaps } from "./geometry.js?v=396db0bf";
import { exportSTEP, exportDXF, exportOBJ, exportGLB, exportSTL, downloadBlob, collectPartTriangles } from "./exporters.js?v=396db0bf";
import { compileAsset, validateAsset, readinessScore, computeInertial } from "./robot.js?v=396db0bf";
import { exportURDF, exportUSDA, exportMJCF, exportBundle, stripCIR, verifyExports as verifyRobotExports } from "./robot-export.js?v=396db0bf";
import { buildAssetRecord, ASSET_CATEGORIES } from "./asset-record.js?v=396db0bf";
import { measureForm, measurementText, formAgreement, orientUpright, silhouettes } from "./measure.js?v=396db0bf";
import { planRepresentation, buildSpecification, specText } from "./threespec.js?v=396db0bf";
import { specSummary, applyPatch } from "./spec-build.js?v=396db0bf";
import { compileSpec, partsAffectedBy } from "./spec-compile.js?v=396db0bf";
import { buildStructuredSpec, structuredSpecText, rebuildEligibility, MODE, ORIGIN } from "./model-spec.js?v=396db0bf";
import { applyModifiers, runOperation, captureBaseline } from "./modifier.js?v=396db0bf";
import { buildFromSpec, specThreeCode, specSummaryText } from "./spec-cad.js?v=396db0bf";
import { createDroneSim } from "./drone-sim.js?v=396db0bf";
import { positionsFromObject3D, refineFromMesh } from "./mesh-loft.js?v=396db0bf";
import { applyParameter, partFields, applyPartField } from "./drone-params.js?v=396db0bf";
import { COMPONENT_CATALOG, CATALOG_GROUPS, fitTargets, applyComponent, addComponentAsPart } from "./drone-catalog.js?v=396db0bf";
import { PRINTERS, MATERIALS as PRINT_MATERIALS, estimatePrint } from "./print-estimate.js?v=396db0bf";
