...
import { validateShaft, normalizeShaft, DSL_VERSION } from "./shaft-schema.js?v=e9bdacdd";
import { computeMass, totalLength, maxDiameter, buildTopLine, collectEvents } from "./shaft-profile.js?v=e9bdacdd";
import { densityOf } from "./shaft-standards.js?v=e9bdacdd";
import { buildShaft3D, makeMaterials, setSectionPlanes } from "./shaft-cad.js?v=e9bdacdd";
import { drawShaft, toSVG } from "./shaft-drawing.js?v=e9bdacdd";
import { extractHeuristic, extractViaServer } from "./shaft-extract.js?v=e9bdacdd";
import { verifyExtraction, goldenMetrics } from "./shaft-verify.js?v=e9bdacdd";
import { sampleShaft } from "./shaft-sampler.js?v=e9bdacdd";
import { exportSTEP, exportSTL, exportGLB, exportOBJ, exportUSDA, exportDrawingDXF, exportDrawingSVG, exportJSON, downloadBlob } from "./shaft-export.js?v=e9bdacdd";

const BUILD = "e9bdacdd";
