...
import { DSL_VERSION, validateShaft, normalizeShaft } from "./shaft-schema.js?v=2ebcdab1";
import { keywayFor, ISO_COARSE_PITCH, threadSpecText } from "./shaft-standards.js?v=2ebcdab1";
