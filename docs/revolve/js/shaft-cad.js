...
import { CSG } from "./csg.js?v=26efc7b8";
import { buildTopLine, buildInnerLine, collectEvents, totalLength, segmentDiameters, outerDiameterAt } from "./shaft-profile.js?v=26efc7b8";
