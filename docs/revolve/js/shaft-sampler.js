...
import { PREFERRED_DIAMETERS, ISO_COARSE_PITCH, ISO_FINE_PITCHES, threadSpecText, snapRingGroove, keywayFor, centerHoleFor, threadUndercutFor, grindingUndercutFor, SHAFT_TOLERANCE_CLASSES, ROUGHNESS_GRADES } from "./shaft-standards.js?v=26efc7b8";
import { validateShaft, DSL_VERSION } from "./shaft-schema.js?v=26efc7b8";
