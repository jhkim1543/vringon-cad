...
import { silhouetteSamples, totalLength, segmentDiameters, collectEvents } from "./shaft-profile.js?v=26efc7b8";
import { validateShaft } from "./shaft-schema.js?v=26efc7b8";
